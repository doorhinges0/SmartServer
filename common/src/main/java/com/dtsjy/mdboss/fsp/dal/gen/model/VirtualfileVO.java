...
public class VirtualfileVO implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", consult=").append(consult);
    ...
    public boolean equals(Object that) {
        ...
        VirtualfileVO other = (VirtualfileVO) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getConsult() == null ? other.getConsult() == null : this.getConsult().equals(other.getConsult()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getConsult() == null) ? 0 : getConsult().hashCode());
